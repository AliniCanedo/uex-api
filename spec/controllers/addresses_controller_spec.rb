  ...
  describe 'GET #search_address' do
    ...
    context 'when the address is found' do
      ...
      before do
        ...
        allow_any_instance_of(::Addresses::QueryAddressService).to receive(:call).and_return(status: 200,
                                                                                             body: address_data)
        allow_any_instance_of(::Addresses::GeocodingService).to receive(:call).and_return(status: 200,
